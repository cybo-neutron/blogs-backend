...
function authenticateMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var bearer, accessToken, decoded, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bearer = req.headers.authorization;
                    if (!(bearer && bearer.startsWith('Bearer '))) return [3 /*break*/, 3];
                ...
                case 1:
                    ...
                    if (decoded instanceof jsonwebtoken_1.default.JsonWebTokenError) {
                        return [2 /*return*/, next(new http_exception_1.default(401, "Unauthorized"))];
                    }
                    console.log({ decoded: decoded });
                    return [4 /*yield*/, user_model_1.default.findById(decoded.id).select('-password').exec()];
                case 2:
                    user = _a.sent();
                ...
                case 3: return [2 /*return*/, next(new http_exception_1.default(401, "Unauthorized"))];
            }
        });
    });
}
