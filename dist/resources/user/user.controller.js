...
var UserController = /** @class */ (function () {
    function UserController() {
        ...
        this.register = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name_1, email, password, response, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, name_1 = _a.name, email = _a.email, password = _a.password;
                        return [4 /*yield*/, this.userService.register(name_1, email, password)];
                    case 1:
                        response = _b.sent();
                    ...
                    case 2:
                        err_1 = _b.sent();
                        next(new http_exception_1.default(400, err_1.message));
                        return [3 /*break*/, 3];
        ...
        this.login = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        err_2 = _b.sent();
                        next(new http_exception_1.default(400, err_2.message));
                        return [3 /*break*/, 4];
    ...
    UserController.prototype.initializeRoutes = function () {
        ...
        //test
        this.router.get("".concat(this.path), function (req, res) {
            res.send("hello");
        });
    };
